...
describe('allOneSuitAndHonorsPredicate.ts', () => {
    ...
    test('regular hand with honors and one suit tiles returns true', () => {
        ...
        const result = ALL_ONE_SUIT_AND_HONORS_PREDICATE(regularHand, basicWinContext, basicRoundContext, rootConfig);
        
        expect(result.pointPredicateId).toBe(PointPredicateID.ALL_ONE_SUIT_AND_HONORS);
    ...
    test('regular hand with only one suit tiles returns false', () => {
    ...
    test('thirteen orphans hand returns false', () => {
        ...
        const result = ALL_ONE_SUIT_AND_HONORS_PREDICATE(specialHand, basicWinContext, basicRoundContext, rootConfig);
