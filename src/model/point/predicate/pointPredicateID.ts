export enum PointPredicateID {
    ...
    SUBPREDICATE_AT_LEAST_FOUR_EXPOSED_NON_PAIR_MELDS = 'SUBPREDICATE_AT_LEAST_FOUR_EXPOSED_NON_PAIR_MELDS',  
    ...
    SUBPREDICATE_LAST_TILE_COMPLETED_PAIR = 'LAST_TILE_COMPLETED_PAIR',
    SUBPREDICATE_THREE_WINDS_PONG_KONG = 'THREE_WINDS_PONG_KONG', // hand has three pongs (kongs allowed) of different winds
    SUBPREDICATE_FOUR_WINDS_PONG_KONG = 'FOUR_WINDS_PONG_KONG', // hand has four pongs (kongs allowed) of diff winds
    SUBPREDICATE_TWO_DRAGONS_PONG_KONG = 'TWO_DRAGONS_PONG_KONG',
