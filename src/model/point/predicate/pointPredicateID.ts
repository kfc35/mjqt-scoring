export enum PointPredicateID {
    ...
    SUBPREDICATE_CONTAINS_FOUR_KONGS = 'SUBPREDICATE_CONTAINS_FOUR_KONGS',
    SUBPREDICATE_CONTAINS_FOUR_PONGS_AND_KONGS = 'SUBPREDICATE_CONTAINS_FOUR_PONGS_AND_KONGS',
    ...
    SUBPREDICATE_CONTAINS_FOUR_CONCEALED_NON_PAIR_MELDS = 'SUBPREDICATE_CONTAINS_FOUR_CONCEALED_NON_PAIR_MELDS',    
    SUBPREDICATE_CONTAINS_FOUR_CONCEALED_MELDS = 'SUBPREDICATE_CONTAINS_FOUR_CONCEALED_MELDS',    
    SUBPREDICATE_CONTAINS_FOUR_EXPOSED_NON_PAIR_MELDS = 'SUBPREDICATE_CONTAINS_FOUR_EXPOSED_NON_PAIR_MELDS',  
    ...
    SUBPREDICATE_FOUR_WINDS_PONG_KONG = 'SUBPREDICATE_FOUR_WINDS_PONG_KONG', // hand has four pongs (kongs allowed) of diff winds
    SUBPREDICATE_TWO_DRAGONS_PONG_KONG = 'SUBPREDICATE_TWO_DRAGONS_PONG_KONG',
    SUBPREDICATE_SUFFICIENT_TILE_QUANTITIES_FOR_NINE_GATES = 'SUBPREDICATE_SUFFICIENT_TILE_QUANTITIES_FOR_NINE_GATES',
