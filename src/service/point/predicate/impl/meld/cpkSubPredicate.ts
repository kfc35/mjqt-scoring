...
export const atLeastFourChowsSubPredicate: PointPredicate<MeldBasedWinningHand> = createChowMinQuantityPredicate(PointPredicateID.SUBPREDICATE_AT_LEAST_FOUR_CHOWS, 4);export const atLeastFourKongsSubPredicate: PointPredicate<MeldBasedWinningHand> = createKongMinQuantityPredicate(PointPredicateID.SUBPREDICATE_AT_LEAST_FOUR_KONGS, 4);
